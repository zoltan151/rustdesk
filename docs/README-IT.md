<p align="center">
  ...
  <b>Abbiamo bisogno del tuo aiuto per tradurre questo file README e la <a href="https://github.com/zoltan151/rustdesk/tree/master/src/lang">UI RustDesk</a> nella tua lingua nativa</b>
</p>
...
[**SCARICA PROGRAMMA**](https://github.com/zoltan151/rustdesk/releases)

[**SCARICA NIGHTLY**](https://github.com/zoltan151/rustdesk/releases/tag/nightly)
...
Le versioni desktop utilizzano Flutter o Sciter (deprecato) per l'interfaccia utente, questo tutorial è solo per Sciter, poiché è più facile per iniziare. Controlla il nostro [CI](https://github.com/zoltan151/rustdesk/blob/master/.github/workflows/flutter-build.yml) per la compilazione della versione Flutter.
...
- **[libs/hbb_common](https://github.com/zoltan151/rustdesk/tree/master/libs/hbb_common)**: codec video, config, wrapper tcp/udp, protobuf, funzioni per il trasferimento file, e altre funzioni utili.
- **[libs/scrap](https://github.com/zoltan151/rustdesk/tree/master/libs/scrap)**: cattura dello schermo
- **[libs/enigo](https://github.com/zoltan151/rustdesk/tree/master/libs/enigo)**: controllo tastiera/mouse specifico della piattaforma
- **[libs/clipboard](https://github.com/zoltan151/rustdesk/tree/master/libs/clipboard)**: implementazione del copia e incolla dei file per Windows, Linux, macOS.
- **[src/ui](https://github.com/zoltan151/rustdesk/tree/master/src/ui)**: Sciter UI obsoleto (deprecato)
- **[src/server](https://github.com/zoltan151/rustdesk/tree/master/src/server)**: servizi audio/appunti/input/video e connessioni di rete
- **[src/client.rs](https://github.com/zoltan151/rustdesk/tree/master/src/client.rs)**: avvio di una connessione peer
- **[src/rendezvous_mediator.rs](https://github.com/zoltan151/rustdesk/tree/master/src/rendezvous_mediator.rs)**: comunica con [rustdesk-server](https://github.com/zoltan151/rustdesk-server), attende la connessione remota diretta (TCP hole punching) oppure indiretta (relayed)
- **[src/platform](https://github.com/zoltan151/rustdesk/tree/master/src/platform)**: codice specifico della piattaforma
- **[flutter](https://github.com/zoltan151/rustdesk/tree/master/flutter)**: codice Flutter per desktop e mobile
- **[flutter/web/js](https://github.com/zoltan151/rustdesk/tree/master/flutter/web/js)**: JavaScript per client web Flutter
